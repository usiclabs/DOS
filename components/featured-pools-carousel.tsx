...
export function FeaturedPoolsCarousel({ pools, onDeployClick }: FeaturedPoolsCarouselProps) {
  ...
  return (
    <div className="relative w-full mb-6 md:mb-8 overflow-hidden">
      ...
      <div className="relative h-[500px] md:h-[550px] rounded-2xl md:rounded-3xl overflow-hidden">
        <AnimatePresence initial={false} custom={direction} mode="wait">
          ...
          >
            {/* Token image background with gradient overlay */}
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-2 md:gap-4">
                  ...
                  <div className="flex items-center -space-x-3 md:-space-x-4">
                    <div className="relative w-12 h-12 md:w-20 md:h-20 rounded-full border-2 md:border-4 border-black/50 backdrop-blur-xl bg-white/10 overflow-hidden shadow-2xl">
                      <img
                  ...
                  {/* Pool info */}
                  <div>
                    <h3 className="text-xl md:text-4xl font-bold text-white mb-1 md:mb-2">
                  ...
                  <motion.div
                    ...
                    animate={{
                      textShadow: [
                        ...
                        "0 0 30px rgba(74, 222, 128, 0.7), 0 0 60px rgba(74, 222, 128, 0.4)",
                        "0 0 20px rgba(74, 222, 128, 0.5), 0 0 40px rgba(74, 222, 128, 0.3)",
                      ],
                    }}
              ...
              <div className="space-y-3 md:space-y-5">
                ...
                <div className="grid grid-cols-3 gap-2 md:gap-4">
                  <motion.div
                    ...
                    className="backdrop-blur-xl bg-white/5 rounded-xl md:rounded-2xl p-2.5 md:p-4 border border-white/10 hover:border-white/20 transition-all duration-300 hover:bg-white/10"
                  >
                ...
                <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.6 }}>
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-bold text-sm md:text-lg h-12 md:h-16 rounded-xl md:rounded-2xl shadow-2xl shadow-orange-500/50 hover:shadow-orange-500/70 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
                  >
        ...
        <Button
          ...
          size="icon"
          onClick={handlePrev}
          className="absolute left-2 md:left-4 top-1/2 -translate-y-1/2 backdrop-blur-xl bg-white/10 hover:bg-white/20 border border-white/20 rounded-full w-10 h-10 md:w-12 md:h-12 z-10 transition-all duration-300 hover:scale-110 active:scale-95"
        >
        ...
        <Button
          ...
          size="icon"
          onClick={handleNext}
          className="absolute right-2 md:right-4 top-1/2 -translate-y-1/2 backdrop-blur-xl bg-white/10 hover:bg-white/20 border border-white/20 rounded-full w-10 h-10 md:w-12 md:h-12 z-10 transition-all duration-300 hover:scale-110 active:scale-95"
        >
