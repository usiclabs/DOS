    ...
    <div className="min-h-screen bg-background pb-20 md:pb-8">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300">Vote for which projects should receive official pool deployments</p>
        </motion.div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <Vote className="h-5 w-5 text-accent-foreground" />
          ...
          <motion.div variants={fadeInUp} transition={{ duration: 0.4 }}>
            <Card className="glass-card hover:scale-105 transition-transform duration-300">
              <CardContent className="p-6">
                ...
                <div className="text-2xl font-bold text-white">
                  {isConnected ? formatVotes(votingStats.votingPower) : "Connect Wallet"}
                </div>
                {isConnected && getTotalVotesAllocated() > 0 && (
                  <div className="text-sm text-gray-400 mt-1">{formatVotes(getRemainingVotingPower())} remaining</div>
                )}
              </CardContent>
            </Card>
          </motion.div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-400">Global Epoch Rewards</span>
                  </div>
                </div>
                <div className="text-2xl font-bold text-white">${votingStats.epochRewards.toFixed(2)}</div>
              </CardContent>
            </Card>
          </motion.div>
          ...
          <Card className="glass-card mb-8">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-3">
                <span className="text-sm text-gray-400">Global Power Used</span>
                <span className="text-sm font-semibold text-white">{votingStats.globalPowerUsed.toFixed(2)}%</span>
              </div>
              <Progress value={votingStats.globalPowerUsed} className="h-2" />
            </CardContent>
          </Card>
        </motion.div>
